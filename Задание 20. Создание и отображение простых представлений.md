...
### 6.1. Открытие базового шаблона

- Если у вас есть базовый шаблон, например, `base.html` в `templates/`, откройте его.
- Если базового шаблона нет, вы можете обновить навигацию в каждом шаблоне отдельно.

### 6.2. Добавление навигационного меню

**Добавьте следующий код в секцию `<body>` вашего базового шаблона или в нужные шаблоны:**
...
### 6.3. Обновление других шаблонов (при необходимости)

- Если у вас нет базового шаблона, скопируйте навигационное меню в другие шаблоны, такие как `home.html`, `services.html`, `team.html`, `gallery.html`.

### 6.4. Сохраните изменения
