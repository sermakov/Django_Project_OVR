...
- [Документация Django: Шаблоны](https://docs.djangoproject.com/en/5.1/topics/templates/)
- [Django Template Language (DTL) Cheatsheet](https://docs.djangoproject.com/en/5.1/ref/templates/language/)
- [Основы представлений в Django](https://docs.djangoproject.com/en/5.1/topics/http/views/)
- [Настройка URL маршрутов](https://docs.djangoproject.com/en/5.1/topics/http/urls/)
