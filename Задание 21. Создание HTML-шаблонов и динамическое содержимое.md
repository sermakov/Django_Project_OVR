...
Поскольку мы не используем модели, мы можем передать статический список мероприятий.
...
def home(request):
    events = [
        {'id': 1, 'title': 'Концерт классической музыки', 'date': '2023-11-10 19:00'},
        {'id': 2, 'title': 'Выставка современного искусства', 'date': '2023-11-15 10:00'},
        {'id': 3, 'title': 'Театральная постановка', 'date': '2023-11-20 18:30'},
    ]
...
2. **Создайте шаблон `event_detail.html`:**
