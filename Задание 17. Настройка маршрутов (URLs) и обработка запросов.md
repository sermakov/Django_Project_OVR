## Практическое занятие 17. Настройка маршрутов (URLs) и обработка запросов
...
1. **Введение в маршрутизацию Django (10 минут)**
2. **Добавление основных маршрутов в `events/urls.py` (20 минут)**
3. **Создание простых представлений в `events/views.py` (20 минут)**
4. **Создание базовых HTML-шаблонов (15 минут)**
5. **Тестирование настроенных маршрутов и представлений (15 минут)**
6. **Практическое упражнение: Добавление нового маршрута и представления (20 минут)**
7. **Дополнительные задания: Создание приложений `about` и `contact` (20 минут)**
8. **Заключение и вопросы (10 минут)**

---

### Задача 1: Введение в маршрутизацию Django (10 минут)
...
### Задача 2: Добавление основных маршрутов в `events/urls.py` (20 минут)
...
### Задача 3: Создание простых представлений в `events/views.py` (20 минут)
...
### Задача 4: Создание базовых HTML-шаблонов (15 минут)
...
### Задача 5: Тестирование настроенных маршрутов и представлений (15 минут)
...
### Задача 6: Практическое упражнение: Добавление нового маршрута и представления (20 минут)
...
### Задача 7: Дополнительные задания: Создание приложений `about` и `contact` (20 минут)
