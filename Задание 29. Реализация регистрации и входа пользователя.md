...
- [Документация Django: Аутентификация](https://docs.djangoproject.com/en/5.1/topics/auth/)
- [Документация Django: Форма регистрации пользователей](https://docs.djangoproject.com/en/5.1/topics/auth/default/#django.contrib.auth.forms.UserCreationForm)
