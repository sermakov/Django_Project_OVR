...
- [Документация Django: Работа с файлами](https://docs.djangoproject.com/en/5.1/topics/files/)
- [Документация Django: Настройка админ-панели](https://docs.djangoproject.com/en/5.1/ref/contrib/admin/)
