...
1. **Введение в добавление файлов через админ-панель (10 минут)**
2. **Настройка модели для загрузки изображений и документов (20 минут)**
3. **Настройка админ-панели для работы с файлами (15 минут)**
4. **Настройка обработки медиа-файлов в Django (15 минут)**
5. **Отображение загруженных файлов на сайте (20 минут)**
6. **Практическое упражнение: Добавление мероприятий с файлами через админ-панель (10 минут)**
7. **Дополнительное задание**

---

## Задача 1: Введение в добавление файлов через админ-панель (10 минут)
...
## Задача 2: Настройка модели для загрузки изображений и документов (20 минут)
...
## Задача 3: Настройка админ-панели для работы с файлами (15 минут)
...
## Задача 4: Настройка обработки медиа-файлов в Django (15 минут)
...
## Задача 5: Отображение загруженных файлов на сайте (20 минут)
...
## 6.2. Создайте или обновите шаблон `gallery.html`
...
### 6.3: Добавьте маршрут для галереи.
