...
1. **Повторение основ DRF и сериализаторов (10 минут)**
2. **Создание вложенных сериализаторов для моделей `Event` и `Review` (30 минут)**
3. **Использование ViewSets и маршрутизаторов (20 минут)**
4. **Реализация фильтрации, поиска и пагинации (30 минут)**
5. **Настройка разрешений и аутентификации (20 минут)**
6. **Тестирование API с использованием Postman или другого инструмента (10 минут)**
7. **Дополнительные задания**

---

## Задача 1: Повторение основ DRF и сериализаторов (10 минут)
...
## Задача 2: Создание вложенных сериализаторов для моделей `Event` и `Review` (30 минут)
...
## Задача 3: Использование ViewSets и маршрутизаторов (20 минут)
...
## Задача 4: Реализация фильтрации, поиска и пагинации (30 минут)
...
## Задача 5: Настройка разрешений и аутентификации (20 минут)
...
## Задача 6: Тестирование API с использованием Postman или другого инструмента (10 минут)
