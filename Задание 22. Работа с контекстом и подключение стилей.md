...
1. **Введение в контекст и статические файлы в Django (10 минут)**
2. **Передача данных через контекст (15 минут)**
3. **Использование контекста в шаблонах (15 минут)**
4. **Подключение CSS-стилей (20 минут)**
5. **Использование стилей в шаблонах (15 минут)**
6. **Запуск и проверка приложения (10 минут)**
7. **Практическое упражнение: Улучшение внешнего вида сайта (5 минут)**
8. **Дополнительное задание**

---

## Задача 1: Введение в контекст и статические файлы в Django (10 минут)
...
## Задача 2: Передача данных через контекст (15 минут)
...
## Задача 3: Использование контекста в шаблонах (15 минут)
...
## Задача 4: Подключение CSS-стилей (20 минут)
...
### 4.2. Создание файла `styles.css`

**Создайте файл `styles.css` в `events/static/events/css/` и добавьте следующий код:**
...
2. **В секции `<head>` добавьте подключение стилей:**
...
## Задача 5: Использование стилей в шаблонах (15 минут)
...
## Задача 7: Практическое упражнение: Улучшение внешнего вида сайта (5 минут)
