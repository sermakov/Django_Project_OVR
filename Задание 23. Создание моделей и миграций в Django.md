...
1. **Введение в модели и миграции Django (10 минут)**
2. **Создание модели `Category` (15 минут)**
3. **Создание модели `Event` (20 минут)**
4. **Создание модели `Registration` (15 минут)**
5. **Создание модели `Review` (15 минут)**
6. **Создание модели `Comment` (10 минут)**
7. **Создание модели `Profile` (15 минут)**
8. **Создание и применение миграций (10 минут)**
9. **Запуск и проверка приложения (5 минут)**
10. **Практическое упражнение: Создание собственной модели (5 минут)**
11. **Дополнительное задание**

---

## Задача 1: Введение в модели и миграции Django (10 минут)
...
## Задача 2: Создание модели `Category` (15 минут)
...
## Задача 3: Создание модели `Event` (20 минут)
...
## Задача 4: Создание модели `Registration` (15 минут)
...
## Задача 5: Создание модели `Review` (15 минут)
...
## Задача 6: Создание модели `Comment` (10 минут)
...
## Задача 7: Создание модели `Profile` (15 минут)
...
## Задача 8: Создание и применение миграций (10 минут)
...
## Задача 9: Запуск и проверка приложения (5 минут)
...
## Задача 10: Практическое упражнение (5 минут)
