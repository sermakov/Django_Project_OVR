...
- [Документация Django: Модели](https://docs.djangoproject.com/en/5.1/topics/db/models/)
- [Документация Django: Миграции](https://docs.djangoproject.com/en/5.1/topics/migrations/)
- [Документация Django: Админ-панель](https://docs.djangoproject.com/en/5.1/ref/contrib/admin/)
