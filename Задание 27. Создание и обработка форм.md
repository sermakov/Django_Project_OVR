...
1. **Введение в формы Django (10 минут)**
2. **Создание модели `Review` (15 минут)**
3. **Создание формы `ReviewForm` (15 минут)**
4. **Обновление представления `event_detail` для обработки формы (20 минут)**
5. **Обновление шаблона `event_detail.html` для отображения формы и отзывов (20 минут)**
6. **Практическое упражнение: Добавление отзывов к мероприятиям (10 минут)**
7. **Дополнительное задание**

---

## Задача 1: Введение в формы Django (10 минут)
...
## Задача 2: Создание модели `Review` (15 минут)
...
## Задача 3: Создание формы `ReviewForm` (15 минут)
...
## Задача 4: Обновление представления `event_detail` для обработки формы (20 минут)
...
## Задача 5: Обновление шаблона `event_detail.html` для отображения формы и отзывов (20 минут)
...
## Задача 6: Практическое упражнение: Добавление отзывов к мероприятиям (10 минут)
